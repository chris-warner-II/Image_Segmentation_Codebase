...
%% THIS ISNT WORKING YET AND I AM NOT USING..

MethodType = {'Mod_N&G','Mod_SKHAdj','GLnrm'};
radmax = [inf,1:10]; %[1:7,inf]; % [1:4,inf];
sigpix = [0.1,0.2,0.3,0.4];
imdim =  {[51,51]}; % {'full'}; %
...
jobs_per_cpu = 33; % 44 combinations of rM & sP
numCPUs = 4;
