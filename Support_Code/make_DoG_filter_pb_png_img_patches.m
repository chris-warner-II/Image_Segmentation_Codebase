function pb = make_DoG_filter_pb_png_img_patches(sigC,sigS,Krat)
...
sig_tag = ['C',num2str(sigC),'_S',num2str(sigS),'_Kr',num2str(Krat)];
sig_tag(sig_tag=='.')='p';
...
pbOutDir = [matInDir,'blur_sig',sig_tag,'/pb_png/'];
