function visualize_single_imgPtch_compare_all_methods_optimized_Eig
    ...
    % Optimal Parameters: (recorded by hand) ordered with method.                
                     % maxGT              % meanGT
    rM_optimal = [ [4, 4, 4, 4, 4] ; [4, 4, 4, 4, 4] ] ;
    eV_optimal = [ [7, 1, 2, 4, 3] ; [7, 1, 2, 4, 3] ];
    ...
    j=1; 
    benchDirSK = [spectral_pre,method{j},'/benchmark_results/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    pbDirSK = [spectral_pre,method{j},'/pb_png/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    %
    % Method = Mod_NG with maxGT
    j=2; 
    benchDirNG = [spectral_pre,method{j},'/benchmark_results/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    pbDirNG = [spectral_pre,method{j},'/pb_png/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    %
    % Method = AA with maxGT
    j=3; 
    benchDirAA = [spectral_pre,method{j},'/benchmark_results/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    pbDirAA = [spectral_pre,method{j},'/pb_png/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    % 
    % Method = GL with maxGT
    j=4; 
    benchDirGL = [spectral_pre,method{j},'/benchmark_results/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    pbDirGL = [spectral_pre,method{j},'/pb_png/rM',rM{rM_optimal(k,j)},'/sDInf/sP0p2/',eV{eV_optimal(k,j)},'/'];
    % 
    % Method = IsoDiff with maxGT
    j=5; 
    benchDirIso = [spectral_pre,method{j},'/benchmark_results/rM',rM{rM_optimal(k,j)},'/',eV{eV_optimal(k,j)},'/'];
    pbDirIso = [spectral_pre,method{j},'/pb_png/rM',rM{rM_optimal(k,j)},'/',eV{eV_optimal(k,j)},'/'];
    ...
    outDir = [dirPre,'output/Kuramoto/NetsFromImgs/BSDS_patch_101x101_ds1_',blurTag,'/imgs/spectral/compare_single_imgPtchs_all_methods_optimized/'];
    if ~exist(outDir,'dir')
        mkdir(outDir)
    end
